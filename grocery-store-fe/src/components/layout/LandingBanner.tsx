...
//   return (
//     <div className="flex flex-col sm:flex-row items-center  sm:justify-between gap-6  md:gap-10 p-2 max-h-100 md:p-4">
...
//             </h1>
//             <p className='text-sm'>Enjoy hassle-free online grocery shopping with fast delivery and the best quality product</p>
//             <Button label='Shop now' handleClick={onExploreClick} customStyles='max-w-[150px]' />
//         </div>
//         <div className="flex-1 flex justify-center">
//           <img src={BannerImg} alt="landing banner" loading='lazy' className="w-full max-w-md sm:max-w-lg lg:max-w-2xl object-contain" />
//         </div>
//     </div>
//   )
// }
